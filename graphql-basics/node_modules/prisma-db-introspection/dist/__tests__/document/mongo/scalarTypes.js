...
var mongoTypes_1 = require("../data/mongoTypes");
...
describe('Mongo Model Introspector, end to end', function () {
    ...
    it('Scalar Types', function () { return __awaiter(_this, void 0, void 0, function () {
        var connector, introspection, schema;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, env.createCollections({ scalars: mongoTypes_1.scalars })];
                case 1:
                    _a.sent();
                ...
                case 3:
                    schema = _a.sent();
                    expect(schema).toEqual(mongoTypes_1.schemaString);
                    return [2 /*return*/];
            }
        });
    }); }, 10000);
