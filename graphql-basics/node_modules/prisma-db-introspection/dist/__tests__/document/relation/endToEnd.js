...
describe('Document relation inferring, end to end examples', function () {
    it('Webshop', function () { return __awaiter(_this, void 0, void 0, function () {
        var mockDataSource, result, sdl, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    mockDataSource = new mockDataSource_1.MockDocumentDataSource(webshop_1.collections);
                ...
                case 3:
                    _a.apply(void 0, [_b.sent()]).toBe(webshop_1.schemaString);
                    return [2 /*return*/];
            }
        });
    }); });
