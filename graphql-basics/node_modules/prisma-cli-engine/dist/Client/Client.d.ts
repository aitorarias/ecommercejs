...
export declare class Client {
    ...
    isAuthenticated(): Promise<AuthenticationPayload>;
    ...
    hasStepsApi(): Promise<boolean>;
    deploy(name: string, stage: string, types: string, dryRun: boolean, subscriptions: FunctionInput[], secrets: string[] | null, force?: boolean): Promise<DeployPayload>;
